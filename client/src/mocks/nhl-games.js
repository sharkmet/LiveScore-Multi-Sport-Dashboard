/**
 * Client-side NHL mock games — mirrors the normalized GameEvent shape
 * that the server adapter produces.
 */

const now = new Date()

// ─── Live: BOS @ TOR — 2nd period, BOS leads 3-2, power play ────────────────

export const NHL_LIVE_GAME_ID      = 'nhl-2024-001'
export const NHL_FINAL_GAME_ID     = 'nhl-2024-002'
export const NHL_FINAL_OT_GAME_ID  = 'nhl-2024-003'
export const NHL_SCHEDULED_GAME_ID = 'nhl-2024-004'

const nhlLiveGame = {
  gameId: NHL_LIVE_GAME_ID,
  league: 'nhl',
  status: 'live',
  scheduleDay: 'today',
...
const nhlFinalGame = {
  ...
  boxScore: {
    away: {
      skaters: [
        { name: 'A. Panarin',   goals: 1, assists: 2, points: 3, plusMinus:  2, pim: 0, shots: 4 },
        { name: 'V. Trocheck',  goals: 1, assists: 1, points: 2, plusMinus:  1, pim: 0, shots: 3 },
        { name: 'A. Fox',       goals: 1, assists: 1, points: 2, plusMinus:  2, pim: 0, shots: 2 },
        { name: 'K. Kakko',     goals: 1, assists: 0, points: 1, plusMinus:  1, pim: 0, shots: 3 },
        { name: 'M. Zibanejad', goals: 0, assists: 1, points: 1, plusMinus:  0, pim: 0, shots: 2 },
        { name: 'J. Jones',     goals: 0, assists: 1, points: 1, plusMinus:  1, pim: 2, shots: 1 },
        { name: 'B. Trouba',    goals: 0, assists: 0, points: 0, plusMinus:  0, pim: 0, shots: 1 },
      ],
      goalies: [
    ...
    home: {
      skaters: [
        { name: 'T. Konecny',  goals: 1, assists: 0, points: 1, plusMinus: -1, pim: 0, shots: 3 },
        { name: 'S. Laughton', goals: 0, assists: 1, points: 1, plusMinus:  0, pim: 0, shots: 1 },
        { name: 'S. Farabee',  goals: 0, assists: 0, points: 0, plusMinus: -2, pim: 2, shots: 2 },
        { name: 'O. Makar',    goals: 0, assists: 0, points: 0, plusMinus: -1, pim: 0, shots: 1 },
        { name: 'I. Provorov', goals: 0, assists: 0, points: 0, plusMinus: -1, pim: 0, shots: 0 },
      ],
      goalies: [
...
// ─── Final/OT: EDM 3 @ CGY 2 (OT) ──────────────────────────────────────────

const nhlFinalOtGame = {
  gameId: NHL_FINAL_OT_GAME_ID,
  league: 'nhl',
  status: 'final',
  scheduleDay: 'today',
  ...
  boxScore: {
    away: {
      skaters: [
        { name: 'L. Draisaitl', goals: 2, assists: 1, points: 3, plusMinus:  1, pim: 0, shots: 5 },
        { name: 'C. McDavid',   goals: 1, assists: 2, points: 3, plusMinus:  2, pim: 0, shots: 4 },
        { name: 'Z. Hyman',     goals: 0, assists: 1, points: 1, plusMinus:  1, pim: 0, shots: 2 },
        { name: 'E. Kane',      goals: 0, assists: 1, points: 1, plusMinus:  0, pim: 2, shots: 1 },
        { name: 'D. Nurse',     goals: 0, assists: 0, points: 0, plusMinus:  0, pim: 0, shots: 1 },
      ],
      goalies: [
    ...
    home: {
      skaters: [
        { name: 'E. Lindholm', goals: 1, assists: 0, points: 1, plusMinus:  0, pim: 0, shots: 3 },
        { name: 'T. Toffoli',  goals: 1, assists: 0, points: 1, plusMinus: -1, pim: 0, shots: 3 },
        { name: 'N. Backlund', goals: 0, assists: 1, points: 1, plusMinus:  1, pim: 0, shots: 1 },
        { name: 'B. Gaudreau', goals: 0, assists: 1, points: 1, plusMinus: -1, pim: 2, shots: 2 },
        { name: 'M. Tanev',    goals: 0, assists: 1, points: 1, plusMinus:  0, pim: 0, shots: 0 },
      ],
      goalies: [
...
export const mockNhlGames = [nhlLiveGame, nhlFinalGame, nhlFinalOtGame, nhlScheduledGame]
